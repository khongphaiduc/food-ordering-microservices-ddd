...
{
    public class GetResultCommendFoodService : GeminiFoodlyGrpc.GeminiFoodlyGrpcBase
    {
        private readonly LoadFullProductService _GeminiAIFood;

        public GetResultCommendFoodService(LoadFullProductService loadFullProductService)
        {
