        ...
        modelBuilder.Entity<ProductDailyInventory>(entity =>
        {
            ...
            entity.ToTable("product_daily_inventories", table =>
            {
                table.HasCheckConstraint(
                    "ck_daily_inventory_initial_quantity",
                    "initial_quantity >= 0");

                table.HasCheckConstraint(
                    "ck_daily_inventory_remaining_quantity",
                    "remaining_quantity >= 0");

                table.HasCheckConstraint(
                    "ck_daily_inventory_sold_quantity",
                    "sold_quantity >= 0");

                table.HasCheckConstraint(
                    "ck_daily_inventory_quantity_balance",
                    "remaining_quantity + sold_quantity = initial_quantity");
            });
            ...
            entity.HasOne(d => d.Product)
                .WithMany(p => p.ProductDailyInventories)
                .HasForeignKey(d => d.ProductId)
