...
using user_service.UserService.Infrastructure.RabbitMQConsumers;
using user_service.UserService.Infrastructure.ServiceImplement;
using user_service.UserService.Infrastructure.Repository;
using user_service.UserService.Domain.Interfaces;

namespace user_service.UserService.Infrastructure.Persistence
{
